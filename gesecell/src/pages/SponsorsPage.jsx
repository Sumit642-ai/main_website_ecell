  ...
  const sponsorTiers2026 = [
    {
      ...
      size: 'xl',
      sponsors: [
        { name: 'Title Media Partner', logo: '/sponsor26/Title_Media_Partner_2_2026.png', link: 'https://www.sbilife.co.in/' }
      ]
    },
    {
      title: 'Co-Title Partner',
      size: 'xl',
      sponsors: [
        { name: 'Co-Title Partner', logo: '/sponsor26/C0_Title_Partner_2026.png', link: 'https://blinkx.in/' }
      ]
    },
    {
      title: 'Title Media Partner',
      size: 'md',
      sponsors: [
        { name: 'Title Media Partner', logo: '/sponsors/Titlemediapartner.png.png', link: 'https://timesofindia.indiatimes.com/' }
      ]
    },
    {
      title: 'Associate Partners',
      size: 'md',
      sponsors: [
        { name: 'Associate Partner 1', logo: '/sponsor26/Associate_Partner_1_2026.png', link: 'https://www.unicornivc.com/' },
        { name: 'Associate Partner 2', logo: '/sponsor26/Associate_partner_2_2026.jpg', link: 'https://bankofindia.bank.in/' },
        { name: 'Associate Partner 3', logo: '/sponsor26/Associate_Partner_3_2026.jpeg', link: 'https://internxt.com/' },
        { name: 'Associate Partner 4', logo: '/sponsor26/Associate_partner_4_2026.png', link: 'https://www.monad.com' }
      ]
    },
    {
      title: 'Strategic Partner',
      size: 'md',
      sponsors: [
        { name: 'Strategic Partner', logo: '/sponsor26/Strategic_Partner_2026.jpg', link: 'https://www.hdfc.bank.in/' }
      ]
    },
    {
    ...
    },
    {
      ...
      size: 'md',
      sponsors: [
        { name: 'Automobile Partner', logo: '/sponsor26/Automobile_Partner_2026.png', link: 'https://e-went.com/' }
      ]
    },
    {
      title: 'Corporate Partners',
      size: 'sm',
      sponsors: [
        { name: 'Corporate Partner 1', logo: '/sponsor26/Corporate_Partner_1_2026.svg', link: 'https://www.questionwhatsreal.com/' },
        { name: 'Corporate Partner 2', logo: '/sponsor26/Corporate_Partner_2_2026.png', link: 'https://www.surya.co.in/' },
        { name: 'Corporate Partner 3', logo: '/sponsor26/Corporate_Partner_3_2026.jpeg', link: 'https://www.reclasteel.com/' }
      ]
    },
    {
...

    {
      ...
      size: 'sm',
      sponsors: [
        { name: 'Merchandise Partner', logo: '/sponsor26/Merchandise_Partner_2026.jpeg', link: 'https://www.indiamart.com/' }
      ]
    },
    {
      ...
      size: 'sm',
      sponsors: [
        { name: 'Ticketing Partner', logo: '/sponsor26/Ticketing_Partner_2026.svg', link: 'https://www.meraevents.com/' }
      ]
    },
    {
      ...
      size: 'sm',
      sponsors: [
        { name: 'Technology Partner', logo: '/sponsor26/Technology_Partner_2026.png', link: 'https://tallysolutions.com/' }
      ]
    },
    {
      ...
      size: 'sm',
      sponsors: [
        { name: 'Study Abroad Partner 2', logo: '/sponsor26/Study_Abroad_Partner_2026.jpeg', link: 'https://www.idp.com/' }
      ]
    },
    {
      ...
      size: 'sm',
      sponsors: [
        { name: 'Official Beverage Partner', logo: '/sponsor26/Official_Beverage_Partner_2026.png', link: 'https://campabeverages.com/' }
      ]
    },
    {
      ...
      size: 'sm',
      sponsors: [
        { name: 'Entertainment Partner', logo: '/sponsor26/Entertainment_Partner_2026.png', link: 'https://www.whitehaven.in/' }
      ]
    },
    {
      ...
      size: 'sm',
      sponsors: [
        { name: 'Exclusive Experience Partner', logo: '/sponsor26/Klook-Logo.png', link: 'https://www.klook.com/' }
      ]
    },
    {
      ...
      size: 'sm',
      sponsors: [
        { name: 'Gaming Partner', logo: '/sponsor26/Gaming_Partner_2026.png', link: 'https://www.futuregaming.in/' }
      ]
    },
    {
      ...
      size: 'sm',
      sponsors: [
        { name: 'Hospitality Partner', logo: '/sponsor26/Hospitality_Partner_2026.png', link: 'https://resortparadise.in/' }
      ]
    },
    {
      ...
      size: 'sm',
      sponsors: [
        { name: 'Hydration Partner', logo: '/sponsor26/Hydration_Partner_2026.png', link: 'https://aghorawellness.com/' },
        { name: 'Hydration Partner', logo: '/sponsor26/Hydration_Partner_2026_1.png', link: 'https://aghorawellness.com/' }
      ]
    },
    {
      ...
      size: 'sm',
      sponsors: [
        { name: 'Incubation Partner', logo: '/sponsor26/Incubation_Partner_2026.jpeg', link: 'https://afbic.iitkgp.ac.in/' }
      ]
    },
    {
      ...
      size: 'sm',
      sponsors: [
        { name: 'Knowledge Partner', logo: '/sponsor26/Knowledge_Partner_2026.webp', link: 'https://wadhwanifoundation.org/' }
      ]
    },
    {
    ...
    },
    {
      ...
      size: 'sm',
      sponsors: [
        { name: 'Media Partner 1', logo: '/sponsor26/Media_Partner_1_2026.png', link: 'https://www.aurumproptech.in/' },
        { name: 'Media Partner 2', logo: '/sponsor26/Media_Partner_2_2026.jpg' },
        { name: 'Media Partner 3', logo: '/sponsor26/Media_Partner_3_2026.jpeg', link: 'https://www.cnbc.com/' },
        { name: 'Media Partner 4', logo: '/sponsor26/Media_Partner_4_2026.jpeg', link: 'https://www.news18.com/' },
        { name: 'Media Partner 5', logo: '/sponsor26/Media_Partner_5_2026.png', link: 'https://www.dnaindia.com/' },
        { name: 'Media Partner 6', logo: '/sponsor26/Media_Partner_6_2026.jpg', link: 'https://beau.foundation/' },
        { name: 'Media Partner 7', logo: '/sponsor26/Media_Partner_7_2026.jpg', link: 'https://www.telegraphindia.com/' },
        { name: 'Media Partner 8', logo: '/sponsor26/Media_Partner_8_2026.png', link: 'https://www.freepressjournal.in/' },
        { name: 'Media Partner 9', logo: '/sponsor26/Media_Partner_9_2026.jpg', link: 'https://www.karostartup.com/' },
        { name: 'Media Partner 10', logo: '/sponsor26/Media_Partner_10_2026.png', link: 'https://www.mid-day.com/' },
        { name: 'Media Partner 11', logo: '/sponsor26/Media_Partner_11_2026.jpeg', link: 'https://www.news18.com/' },
        { name: 'Media Partner 12', logo: '/sponsor26/Media_Partner_12_2026.jpeg', link: 'https://www.newsnationtv.com/' },
        { name: 'Media Partner 13', logo: '/sponsor26/Media_Partner_13_2026.jpg', link: 'https://newsreach.in/' },
        { name: 'Media Partner 14', logo: '/sponsor26/Media_Partner_14_2026.png', link: 'https://www.siliconindia.com/' },
        { name: 'Media Partner 15', logo: '/sponsor26/Media_Partner_15_2026.png', link: 'https://indianstartupnews.com/' },
        { name: 'Media Partner 16', logo: '/sponsor26/Media_Partner_16_2026.png', link: 'https://youthincmag.com/' }
      ]
    }
  ];
              ...
              <div className={`sponsor-tier-grid sponsor-tier-grid-${tier.size}`}>
                {tier.sponsors.map((sponsor, idx) => (
                  <div key={idx} className={`sponsor-logo-card sponsor-logo-${tier.size}`}>
                    {sponsor.link ? (
                      <a href={sponsor.link} target="_blank" rel="noopener noreferrer" style={{ display: 'block', width: '100%', height: '100%' }}>
                        {sponsor.logo ? (
